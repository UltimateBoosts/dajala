...
$servicios[] = array("titulo" => "ECOLOGÍA", "image" => "servicio_1.jpg");
$servicios[] = array("titulo" => "ACTUALIZACIÓN EN ASUNTOS AMBIENTALES" , "image" => "servicio_1.jpg");
$servicios[] = array("titulo" => "INGENIERÍA AMBIENTAL", "image" => "servicio_1.jpg");
$servicios[] = array("titulo" => "PLANEACIÓN Y ORDENAMIENTO TERRITORIAL", "image" => "servicio_1.jpg");
$servicios[] = array("titulo" => "ASESORÍAS, CONSULTORÍAS Y APOYOS A ONG’S Y EMPRESAS SIN ÁNIMO DE LUCRO, ECONOMÍA SOLIDARIA DEL SECTOR AMBIENTAL", "image" => "servicio_1.jpg");
$servicios[] = array("titulo" => "DESARROLLO Y EJECUCIÓN PLANES, PROGRAMAS, PROYECTOS Y ACTIVIDADES AMBIENTALES PARA EL POSTCONFLICTO Y BÚSQUEDA Y CONSOLIDACIÓN DE LA PAZ", "image" => "servicio_1.jpg");
$servicios[] = array("titulo" => "PROTECCIÓN SOCIAL INTEGRAL DE LAS PERSONAS AFECTADAS POR LA TOMA DE DECISIONES EN MATERIA DE CUMPLIMIENTO DE DECISIONES JUDICIALES O DE POLÍTICAS AMBIENTALES", "image" => "servicio_1.jpg");
...
$servicios[] = array("titulo" => "REFORESTACIÓN CON ESPECIES NATIVAS", "image" => "servicio_1.jpg");
$servicios[] = array("titulo" => "REPOBLAMIENTO DE REFORESTACIÓN", "image" => "servicio_1.jpg");
...
$servicios[] = array("titulo" => "CULTURA MARÍTIMA Y OCEÁNICA", "image" => "servicio_1.jpg");
$servicios[] = array("titulo" => "RECUPERACIÓN Y MANEJO DE LA ESTRUCTURA ECOLÓGICA PRINCIPAL", "image" => "servicio_1.jpg");
$servicios[] = array("titulo" => "AMBIENTE SANO PARA LA EQUIDAD Y DISFRUTE DEL CIUDADANO", "image" => "servicio_1.jpg");
